...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-4 text-center sb my-2">
            ...
            <?php 
                ...
                $social_image = 'https://bookiwrote.co.uk/'. $f->image;
                $social_url = 'https://bookiwrote.co.uk/book_details/'. $f->id;
            ?>
        ...
        <div class="col-sm-12 col-md-4  text-center sb my-2">
            <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-hashtags="<?php echo str_replace(' ', '', $social_title); ?>,bookiwrote" data-show-count="false">Tweet</a>
